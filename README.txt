...
4. Dentro de la consola de comandos de Sqlite ejecutar el comando:
	.read sentenciasSQL.txt
5. Al final se ejecutará el comando .schema como comprobación de la construcción del esquema y del llenado de datos en las tablas
6. En el directorio aparecerá el archivo DBMisil.db
